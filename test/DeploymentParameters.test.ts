...
suite("DeploymentParameters", () => {
    ...
    //         const dt = new DeploymentParameters(`{ "parameters": { "pName": {} } }`,fakeId);
    ...
    //         const dt = new DeploymentParameters(`{ "variables": { "vName": {} } }`,fakeId);
    ...
    //                         let dp = new DeploymentParameters(json,fakeId);
