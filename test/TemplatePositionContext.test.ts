...
suite("TemplatePositionContext", () => {
    ...
    suite("fromDocumentCharacterIndex(DeploymentTemplate,number)", () => {
        ...
        testWithoutBreakOnAssert("with negative documentCharacterIndex", () => {
            const dt = new DeploymentTemplateDoc("{}", fakeId, 0);
            assert.throws(() => { TemplatePositionContext.fromDocumentCharacterIndex(dt, -1, undefined); });
        });

        testWithoutBreakOnAssert("with documentCharacterIndex greater than the maximum character index", () => {
            const dt = new DeploymentTemplateDoc("{}", fakeId, 0);
    ...
    suite("tleParseResult", () => {
        test("with characterIndex in whitespace", () => {
            const dt: DeploymentTemplateDoc = new DeploymentTemplateDoc("{ 'a': 'A', 'b': \"[concat('B')]\" }", fakeId, 0);
    ...
    test("in unrecognized function name", () => {
        const dt = new DeploymentTemplateDoc("{ 'a': 'A', 'b': \"[toads('B'", fakeId, 0);
    ...
    test("in unrecognized parameter reference", () => {
        const dt = new DeploymentTemplateDoc("{ 'a': 'A', 'b': \"[parameters('B')]\" }", fakeId, 0);
    ...
    test("in recognized parameter reference name", () => {
        const dt = new DeploymentTemplateDoc("{ 'parameters': { 'pName': { 'type': 'integer' } }, 'a': 'A', 'b': \"[parameters('pName')\" }", fakeId, 0);
    ...
    test("in parameter reference function with empty string parameter", () => {
        const dt = new DeploymentTemplateDoc("{ 'a': 'A', 'b': \"[parameters('')]\" }", fakeId, 0);
        const pc: TemplatePositionContext = dt.getContextFromDocumentCharacterIndex("{ 'a': 'A', 'b': \"[parameters('".length, undefined);
        const infos: IHoverInfo[] = pc.getHoverInfo().filter(hi => !(hi instanceof FormattedExpressionHoverInfo));
        assert.deepStrictEqual(infos, []);
    });
    ...
    test("in unrecognized variable reference", () => {
        const dt = new DeploymentTemplateDoc("{ 'a': 'A', 'b': \"[variables('B')]\" }", fakeId, 0);
    ...
    test("in recognized variable reference name", () => {
        const dt = new DeploymentTemplateDoc("{ 'variables': { 'vName': 3 }, 'a': 'A', 'b': \"[variables('vName')\" }", fakeId, 0);
    ...
    suite("signatureHelp", () => {
        ...
        test("inside first parameter", () => {
            const dt = new DeploymentTemplateDoc(`{ "a": "[concat('test`, fakeId, 0);
        ...
        test("inside second parameter", () => {
            const dt = new DeploymentTemplateDoc(`{ "a": "[concat('t1', 't2`, fakeId, 0);
        ...
        test("in variadic parameter when function signature has '...' parameter and the current argument is greater than the parameter count", () => {
            const dt = new DeploymentTemplateDoc(`{ "a": "[concat('a', 'b', 'c', 'd', 'e', 'f'`, fakeId, 0);
        ...
        test("in variadic parameter when function signature has '...' parameter and the current argument is equal to the parameter count", () => {
            const dt = new DeploymentTemplateDoc(`{ "a": "[concat('a', 'b', 'c', 'd'`, fakeId, 0);
        ...
        test("in variadic parameter when function signature has 'name...' parameter", () => {
            const dt = new DeploymentTemplateDoc(`{ "a": "[resourceId('a', 'b', 'c', 'd', 'e', 'f', 'g'`, fakeId, 0);
    ...
    suite("parameterDefinition", () => {
        ...
        test("with no parameters property", async () => {
            const dt = new DeploymentTemplateDoc("{ 'a': '[parameters(\"pName\")]' }", fakeId, 0);
        ...
        test("with empty parameters property value", async () => {
            const dt = new DeploymentTemplateDoc("{ 'parameters': {}, 'a': '[parameters(\"pName\")]' }", fakeId, 0);
        ...
        test("with matching parameter definition", async () => {
            const dt = new DeploymentTemplateDoc("{ 'parameters': { 'pName': {} }, 'a': '[parameters(\"pName\")]' }", fakeId, 0);
    ...
    suite("variableDefinition", () => {
        ...
        test("with no variables property", () => {
            const dt = new DeploymentTemplateDoc("{ 'a': '[variables(\"vName\")]' }", fakeId, 0);
        ...
        test("with empty variables property value", () => {
            const dt = new DeploymentTemplateDoc("{ 'variables': {}, 'a': '[variables(\"vName\")]' }", fakeId, 0);
        ...
        test("with matching variable definition", () => {
            const dt = new DeploymentTemplateDoc("{ 'variables': { 'vName': {} }, 'a': '[variables(\"vName\")]' }", fakeId, 0);
