...
suite("asdf", () => {
    ...
    suite("Single resource completions", () => {
        ...
        suite("Second arg completions - resource name", () => {
            createResourceIdCompletionsTest(template, `resourceId('',!)`, [`'name1'`]);
            createResourceIdCompletionsTest(template, `resourceId('', !)`, [`'name1'`]);
            createResourceIdCompletionsTest(template, `resourceId('', ! )`, [`'name1'`]);
        });
    });
    ...
    suite("Multiple resource completions", () => {
        ...
        createResourceIdCompletionsTest(template, `resourceId('',!)`, [`'name1'`, `'name2'`]);
    });
    ...
    suite("Multiple resource completions - deduped names", () => {
        ...
        createResourceIdCompletionsTest(template, `resourceId('',!)`, [`'name'`]);
    });
    ...
    //asdf createResourceIdCompletionsTest(realTemplate, 'resourceId(!)', [["parameters", "parameters($0)"]]);
});
