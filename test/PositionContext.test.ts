...
suite("PositionContext", () => {
    ...
    suite("completionItems", () => {
        ...
        function listPackageCompletion(startIndex: number, length: number): Completion.Item {
            return new Completion.Item("listPackage", "listPackage($0)", new language.Span(startIndex, length), "(function) listPackage(resourceId, apiVersion)", undefined, Completion.CompletionKind.Function);
        }
