...
export function expectedAddCompletion(startIndex: number, length: number): Completion.Item {
    return new Completion.Item("add", "add", new Language.Span(startIndex, length), Completion.CompletionKind.Function, "(function) add(operand1, operand2)", "Returns the sum of the two provided integers.");
}

export function expectedBase64Completion(startIndex: number, length: number): Completion.Item {
    return new Completion.Item("base64", "base64", new Language.Span(startIndex, length), Completion.CompletionKind.Function, "(function) base64(inputString)", "Returns the base64 representation of the input string.");
}
...
export function expectedDivCompletion(startIndex: number, length: number): Completion.Item {
    return new Completion.Item("div", "div", new Language.Span(startIndex, length), Completion.CompletionKind.Function, "(function) div(operand1, operand2)", "Returns the integer division of the two provided integers.");
}

export function expectedEqualsCompletion(startIndex: number, length: number): Completion.Item {
    return new Completion.Item("equals", "equals", new Language.Span(startIndex, length), Completion.CompletionKind.Function, "(function) equals(arg1, arg2)", "Checks whether two values equal each other.");
}

export function expectedIntCompletion(startIndex: number, length: number): Completion.Item {
    return new Completion.Item("int", "int", new Language.Span(startIndex, length), Completion.CompletionKind.Function, "(function) int(valueToConvert)", "Converts the specified value to Integer.");
}
...
export function expectedModCompletion(startIndex: number, length: number): Completion.Item {
    return new Completion.Item("mod", "mod", new Language.Span(startIndex, length), Completion.CompletionKind.Function, "(function) mod(operand1, operand2)", "Returns the remainder of the integer division using the two provided integers.");
}

export function expectedMulCompletion(startIndex: number, length: number): Completion.Item {
    return new Completion.Item("mul", "mul", new Language.Span(startIndex, length), Completion.CompletionKind.Function, "(function) mul(operand1, operand2)", "Returns the multiplication of the two provided integers.");
}

export function expectedPadLeftCompletion(startIndex: number, length: number): Completion.Item {
    return new Completion.Item("padLeft", "padLeft", new Language.Span(startIndex, length), Completion.CompletionKind.Function, "(function) padLeft(stringToPad, totalLength, paddingCharacter)", "Returns a right-aligned string by adding characters to the left until reaching the total specified length.");
}

export function expectedParametersCompletion(startIndex: number, length: number): Completion.Item {
    return new Completion.Item("parameters", "parameters", new Language.Span(startIndex, length), Completion.CompletionKind.Function, "(function) parameters(parameterName)", "Returns a parameter value. The specified parameter name must be defined in the parameters section of the template.");
}
...
export function expectedReferenceCompletion(startIndex: number, length: number): Completion.Item {
    return new Completion.Item("reference", "reference", new Language.Span(startIndex, length), Completion.CompletionKind.Function, "(function) reference(resourceName/resourceIdentifier, [apiVersion], ['Full'])", "Enables an expression to derive its value from another resource's runtime state.");
}

export function expectedReplaceCompletion(startIndex: number, length: number): Completion.Item {
    return new Completion.Item("replace", "replace", new Language.Span(startIndex, length), Completion.CompletionKind.Function, "(function) replace(originalString, oldCharacter, newCharacter)", "Returns a new string with all instances of one character in the specified string replaced by another character.");
}

export function expectedResourceGroupCompletion(startIndex: number, length: number): Completion.Item {
    return new Completion.Item("resourceGroup", "resourceGroup", new Language.Span(startIndex, length), Completion.CompletionKind.Function, "(function) resourceGroup() [object]", "Returns a structured object that represents the current resource group.");
}
...
export function expectedSkipCompletion(startIndex: number, length: number): Completion.Item {
    return new Completion.Item("skip", "skip", new Language.Span(startIndex, length), Completion.CompletionKind.Function, "(function) skip(originalValue, numberToSkip)", "Returns an array or string with all of the elements or characters after the specified number in the array or string.");
}

export function expectedSplitCompletion(startIndex: number, length: number): Completion.Item {
    return new Completion.Item("split", "split", new Language.Span(startIndex, length), Completion.CompletionKind.Function, "(function) split(inputString, delimiter)", "Returns an array of strings that contains the substrings of the input string that are delimited by the sent delimiters.");
}

export function expectedStringCompletion(startIndex: number, length: number): Completion.Item {
    return new Completion.Item("string", "string", new Language.Span(startIndex, length), Completion.CompletionKind.Function, "(function) string(valueToConvert)", "Converts the specified value to String.");
}

export function expectedSubCompletion(startIndex: number, length: number): Completion.Item {
    return new Completion.Item("sub", "sub", new Language.Span(startIndex, length), Completion.CompletionKind.Function, "(function) sub(operand1, operand2)", "Returns the subtraction of the two provided integers.");
}

export function expectedSubscriptionCompletion(startIndex: number, length: number): Completion.Item {
    return new Completion.Item("subscription", "subscription", new Language.Span(startIndex, length), Completion.CompletionKind.Function, "(function) subscription() [object]", "Returns details about the subscription.");
}
...
export function expectedSubstringCompletion(startIndex: number, length: number): Completion.Item {
    return new Completion.Item("substring", "substring", new Language.Span(startIndex, length), Completion.CompletionKind.Function, "(function) substring(stringToParse, startIndex, length)", "Returns a substring that starts at the specified character position and contains the specified number of characters.");
}

export function expectedTakeCompletion(startIndex: number, length: number): Completion.Item {
    return new Completion.Item("take", "take", new Language.Span(startIndex, length), Completion.CompletionKind.Function, "(function) take(originalValue, numberToTake)", "Returns an array or string with the specified number of elements or characters from the start of the array or string.");
}

export function expectedToLowerCompletion(startIndex: number, length: number): Completion.Item {
    return new Completion.Item("toLower", "toLower", new Language.Span(startIndex, length), Completion.CompletionKind.Function, "(function) toLower(string)", "Converts the specified string to lower case.");
}

export function expectedToUpperCompletion(startIndex: number, length: number): Completion.Item {
    return new Completion.Item("toUpper", "toUpper", new Language.Span(startIndex, length), Completion.CompletionKind.Function, "(function) toUpper(string)", "Converts the specified string to upper case.");
}

export function expectedTrimCompletion(startIndex: number, length: number): Completion.Item {
    return new Completion.Item("trim", "trim", new Language.Span(startIndex, length), Completion.CompletionKind.Function, "(function) trim(stringToTrim)", "Removes all leading and trailing white-space characters from the specified string.");
}
...
export function expectedUriCompletion(startIndex: number, length: number): Completion.Item {
    return new Completion.Item("uri", "uri", new Language.Span(startIndex, length), Completion.CompletionKind.Function, "(function) uri(baseUri, relativeUri)", "Creates an absolute URI by combining the baseUri and the relativeUri string.");
}

export function expectedVariablesCompletion(startIndex: number, length: number): Completion.Item {
    return new Completion.Item("variables", "variables", new Language.Span(startIndex, length), Completion.CompletionKind.Function, "(function) variables(variableName)", "Returns the value of variable. The specified variable name must be defined in the variables section of the template.");
}
