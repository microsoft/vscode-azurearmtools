...
suite("ExtractItem", async (): Promise<void> => {
    ...
    async function runExtractParameterTest(startTemplate: string | IPartialDeploymentTemplate, selectedText: string, codeActionsCount: number = 2, expectedTemplate?: string | IPartialDeploymentTemplate): Promise<void> {
    ...
    async function runExtractVariableTest(startTemplate: string | IPartialDeploymentTemplate, selectedText: string, codeActionsCount: number = 2, expectedTemplate?: string | IPartialDeploymentTemplate): Promise<void> {
