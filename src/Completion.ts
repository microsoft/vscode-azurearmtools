...
export interface ICompletionItemsSpyResult {
    document: DeploymentDoc;
    result: Completion.Item[];
}

export class CompletionItemsSpy {
    private readonly _emitter: EventEmitter<ICompletionItemsSpyResult> =
        new EventEmitter<ICompletionItemsSpyResult>();

    public readonly onCompletionItems: Event<ICompletionItemsSpyResult> = this._emitter.event;
