...
async function getLanguageServer(): Promise<void> {
    ...
    console.log("asdfg env.LANGSERVER_NUGET_USERNAME[2] =" + (env.LANGSERVER_NUGET_USERNAME ?? "")[2]);
    console.log("asdfg env.LANGSERVER_NUGET_PASSWORD[2] =" + (env.LANGSERVER_NUGET_PASSWORD ?? "")[2]);
