...
async function getLanguageServer(): Promise<void> {
    ...
    console.log("asdfg env.LANGSERVER_NUGET_USERNAME[1] =" + (env.LANGSERVER_NUGET_USERNAME ?? "")[1]);
    console.log("asdfg env.LANGSERVER_NUGET_PASSWORD[1] =" + (env.LANGSERVER_NUGET_PASSWORD ?? "")[1]);
